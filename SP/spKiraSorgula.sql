...
/****** Object:  StoredProcedure [dbo].[spKiraSorgula]    Script Date: 24.04.2017 18:54:12 ******/
SET ANSI_NULLS ON
GO
...
Where
			kira_donemi=CASE WHEN @kiraDonemi='' THEN kira_donemi ELSE @kiraDonemi END and kira_durumu=@kiraDurumu and
